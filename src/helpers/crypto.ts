...
function base64decode(message: string): Promise<any> {
...
function base64encode(message: string): Promise<any> {
    return new Promise((resolve, reject) => {
...
function pbkdf2(password: string, salt: string): Promise<any> {
    return new Promise((resolve, reject) => {
...
function generateSalt(passwordLength: number): Promise<any> {
    return new Promise((resolve, reject) => {
